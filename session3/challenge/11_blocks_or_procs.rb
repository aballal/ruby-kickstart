...
def array_init (i = 5 , &initializer)
  initializer ||= Proc.new { |i| (i * 100).to_s }
  array = []
  i.times {|i| array << initializer.call(i)}
  array
end
...
result = array_init 10 do |i|           # => [0, -5, 400, -15, 800, -25, 1200, -35, 1600, -45]
    if i % 2 == 0
      i * 200
    else
      i * -5
